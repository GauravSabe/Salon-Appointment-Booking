    ...
    <footer class="bg-gray-900 text-gray-200 py-10 flex flex-col items-center justify-center p-20">
      <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6 md:px-0">
        <div>
          ...
          <p class="text-sm">
            Welcome to my salon booking platform, your one-stop destination for premium
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li>
              <i class="fas fa-phone-alt"></i> +91 9075744121
            </li>
            <li>
              <i class="fas fa-envelope"></i> gauravsabe120104@gmail.com
            </li>
            <li>
              <i class="fas fa-map-marker-alt"></i> 48, Sant Tukaram Nagar, Pimpri Pune - 411018
            </li>
          </ul>
      ...
      <div class="border-t border-gray-700 mt-8 pt-4 text-center text-sm">
        &copy; 2025 Gaurav Sabe. All Rights Reserved.
      </div>
    </footer>
  );
};
